...
class Group(models.Model):
    '''
        A group model where multiple users can share and discuss ideas
    '''
    ...
    def add_user_to_group(self, user: User):
        '''Help function for adding a user to a group and creating an object'''
        self.members.add(user)
        self.event_set.create(type="Join", user=user)
        self.save()

    def remove_user_from_group(self, user: User):
        '''Function for deleting group members when they leave the chat group'''
